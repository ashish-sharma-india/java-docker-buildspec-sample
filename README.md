...
In this example, you'll build a container image of this Java Hello World app, and store your built container 
in a DockerHub repository, all using the OCI DevOps service!
